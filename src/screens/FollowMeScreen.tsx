...
import { View, Text, TouchableOpacity, TextInput, Image, ImageBackground, Alert, Platform } from 'react-native';
...
export const FollowMeScreen: React.FC<FollowMeScreenProps> = ({ componentId }) => {
        ...
        <View>
          ...
          <ShareLinkContainer>
            ...
            <TouchableOpacity onPress={handleShare} style={{padding: 8}}>
              <Icon name="share-2" size={20} color="#4f46e5"/>
            </TouchableOpacity>
          </ShareLinkContainer>
        </View>
